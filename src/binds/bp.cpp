...
void XORINS(void *address) {
    ...
    SET_MEM_PROTECTION_RWX(address);
...
BINDFUNC(breakpoint) {
    ...
    luabridge::getGlobalNamespace(L)
        .beginNamespace("bp")
        .addFunction("b",
                     luabridge::overload<PTR>(BIND_BREAKPOINT::XORINS),
                     luabridge::overload<void *>(BIND_BREAKPOINT::XORINS),
                     luabridge::overload<const char *>(BIND_BREAKPOINT::breakWithSymbol),
                     luabridge::overload<const char *, const char *>(BIND_BREAKPOINT::breakWithSymbol))
        .addFunction("setupAppSignalHandler", BIND_BREAKPOINT::setupAppSignalHandler)
        .endNamespace();
    ...
    BIND_BREAKPOINT::setupAppSignalHandler();
}