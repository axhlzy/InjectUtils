...
UNEXPORT INLINE static inline long __syscall_close(long n, long a) {
#if defined(__arm__)
...
UNEXPORT INLINE static inline long __syscall_read(long n, long a, long b, long c) {
...
UNEXPORT INLINE static inline long __syscall_open(long n, long a, long b, long c, long d) {
#if defined(__arm__) // 编译器会根据宏来选择arm32还是arm64
    register long r7 __asm__("r7") = n;
    register long r0 __asm__("r0") = a;
    register long r1 __asm__("r1") = b;
...
UNEXPORT INLINE static inline long __syscall_lseek(long n, long a, long b, long c) {
#if defined(__arm__) // 编译器会根据宏来选择arm32还是arm64
    register long r7 __asm__("r7") = n;
    register long r0 __asm__("r0") = a;
    register long r1 __asm__("r1") = b;
...
UNEXPORT INLINE int Syscall::my_openat(int __dir_fd, const void *__path, int __flags, int __mode) {
    return (int)__syscall_open(__NR_openat, __dir_fd, (long)__path, __flags, __mode);
}

UNEXPORT INLINE ssize_t Syscall::my_read(int __fd, void *__buf, size_t __count) {
    return __syscall_read(__NR_read, __fd, (long)__buf, (long)__count);
}

UNEXPORT INLINE int Syscall::my_close(int __fd) {
    return (int)__syscall_close(__NR_close, __fd);
}

UNEXPORT INLINE off_t Syscall::my_lseek(int __fd, off_t __offset, int __whence) {
    return (off_t)__syscall_lseek(__NR_lseek, __fd, __offset, __whence);
}

UNEXPORT INLINE std::string Syscall::read_file_for_svc(const char *path) {
...
UNEXPORT std::string Syscall::readFile(const char *filePath) {
    return read_file_for_svc(filePath);
}

//************************************************************************************

UNEXPORT INLINE static inline long __syscall_kill(long flag, long pid, long sig) {
#if defined(__arm__) // 编译器会根据宏来选择arm32还是arm64
...
UNEXPORT INLINE static inline long kill_for_svc(int __pid, int __sig) {
...
//**************************************************************************************************
UNEXPORT INLINE static inline long __syscall_stat(long flag, int dirfd, long path, long buf, int flags) {
#if defined(__arm__)
    register long r7 __asm__("r7") = flag;
...
UNEXPORT INLINE static inline int stat_for_svc(int dirfd, char *path, void *buf, int flags) {
...
//**************************************************************************************************
UNEXPORT INLINE static inline long __syscall_readlink(long flag, long __dir_fd, long path, long buf, long size) {
#if defined(__arm__)
    register long r7 __asm__("r7") = flag;
...
UNEXPORT INLINE static inline long readlink_for_svc(const char *path, char *const buf, size_t size) {
