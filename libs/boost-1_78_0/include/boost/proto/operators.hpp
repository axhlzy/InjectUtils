...
#define BOOST_PROTO_DEFINE_UNARY_OPERATOR(OP, CURRENT, TRAIT, DOMAIN, POST)                             \
    ...
    {                                                                                               \
        return boost::proto::detail::make_expr_<CURRENT, DOMAIN, Arg &>()(arg);                         \
    }                                                                                               \
                                                                                                    \
    template<typename Arg>                                                                          \
    BOOST_PROTO_DISABLE_MSVC_C4714 BOOST_FORCEINLINE                                                \
    ...
    {                                                                                               \
        return boost::proto::detail::make_expr_<CURRENT, DOMAIN, Arg const &>()(arg);                   \
    }                                                                                               \
                                                                                                    \
    BOOST_PROTO_POP_WARNINGS                                                                        \
    /**/

#define BOOST_PROTO_DEFINE_BINARY_OPERATOR(OP, CURRENT, TRAIT, DOMAIN)                                  \
    BOOST_PROTO_PUSH_WARNINGS                                                                       \
                                                                                                    \
    ...
    {                                                                                               \
        return boost::proto::detail::make_expr_<CURRENT, DOMAIN, Left &, Right &>()(left, right);       \
    }                                                                                               \
                                                                                                    \
    template<typename Left, typename Right>                                                         \
    BOOST_PROTO_DISABLE_MSVC_C4714 BOOST_FORCEINLINE                                                \
    ...
    {                                                                                               \
        return boost::proto::detail::make_expr_<CURRENT, DOMAIN, Left &, Right const &>()(left, right); \
    }                                                                                               \
                                                                                                    \
    template<typename Left, typename Right>                                                         \
    BOOST_PROTO_DISABLE_MSVC_C4714 BOOST_FORCEINLINE                                                \
    ...
    {                                                                                               \
        return boost::proto::detail::make_expr_<CURRENT, DOMAIN, Left const &, Right &>()(left, right); \
    }                                                                                               \
                                                                                                    \
    template<typename Left, typename Right>                                                         \
    BOOST_PROTO_DISABLE_MSVC_C4714 BOOST_FORCEINLINE                                                \
    ...
    {                                                                                               \
        return boost::proto::detail::make_expr_<CURRENT, DOMAIN, Left const &, Right const &>()(left, right);\
    }                                                                                               \
                                                                                                    \
    BOOST_PROTO_POP_WARNINGS                                                                        \
    /**/
