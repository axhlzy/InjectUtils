 ...
 * Compile with:
 *
 * clang -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -DANDROID -ffunction-sections -fdata-sections -mthumb frida-core-example.c -o frida-core-example -L. -lfrida-core -llog -ldl -lm -latomic -pthread -Wl,--export-dynamic,--fix-cortex-a8,-z,relro,-z,noexecstack,--gc-sections
 *
