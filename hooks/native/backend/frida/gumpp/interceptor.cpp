...
namespace Gum {
    ...
    public:
        ...
        virtual bool
        attach(void *function_address, InvocationListener *listener, void *listener_function_data) {
            ...
            GumAttachReturn attach_ret = gum_interceptor_attach(handle, function_address,
        ...
        replace(void *function_address, void *replacement_address, void *replacement_data) {
            replace(function_address, replacement_address, replacement_data, NULL);
        }

        virtual void
        replace(void *function_address, void *replacement_address, void *replacement_data, void **original_function) {
            gum_interceptor_replace(handle, function_address, replacement_address, replacement_data, original_function);
        }
    ...
    bool Interceptor::attach(void *function_address, LambdaFunc on_enter,
                             LambdaFunc on_leave, void *listener_function_data) {
        LambdaListener *listener = new LambdaListener(on_enter, on_leave);
        return attach(function_address, listener, listener_function_data);
    }
}
